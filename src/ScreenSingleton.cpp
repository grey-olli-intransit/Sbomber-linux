...
public:
  virtual void ClrScr() override {
    MyTools::FileLoggerSingletone::WriteToLog("ClrScr invoke begin");
    getInternalInstance().ClrScr();
    MyTools::FileLoggerSingletone::WriteToLog("ClrScr invoke end");
  }
  virtual void GotoXY(double x, double y) override {

    MyTools::FileLoggerSingletone::WriteToLog("GotoXY invoke begin");
    getInternalInstance().GotoXY(x, y);
    MyTools::FileLoggerSingletone::WriteToLog("GotoXY invoke end");
  }
